...
//
    ...
    /// Base class for a container object which bundles a collection of ``UIKit/UIViewController``s together to produce a unified experience or composed result
    ///
    ...
    open class FlowContainer: NSObject {
        ...
        /// Provide the initial ``UIKit/UIViewController`` for the flow.
        ...
        /// Start the flow using the provided ``UIKit/UINavigationController``.
        /// This attaches the FlowContainer implementation to the ``UIKit/UINavigationController`` and pushes the initial ``UIKit/UIViewController`` onto it's navigation stack
        /// - Parameters:
        ///   - navigationController: ``UIKit/UINavigationController`` the FlowContainer should attach to
        ///   - animated: True if initial ``UIKit/UIViewController`` should be pushed onto the ``UIKit/UINavigationController`` stack with default animation. Defaults to false when the NavigationStack is empty and true when it is not
        ...
        /// This function will dismiss all presented ``UIKit/UIViewController``s before unwinding its views from the navigation stack
        /// - Parameters:
    ...
    public extension FlowContainer {
        /// Retrieve a ``UIKit/UIViewController`` on the navigation stack via an ID
        /// - Parameter id: Unique Identifier for this ``UIKit/UIViewController``
        /// - Returns: ``UIKit/UIViewController`` identified by _id_, if it exists, on the navigation stack. Nil if no such ViewController is found
        func pushedViewController(id: String) -> UIViewController? {
            pushedControllerObservers.object(forKey: NSString(string: id))
        }

        /// An array of ``UIKit/UIViewController``s pushed by this FlowContainer in the order they exist on the NavigationStack.
        var orderedPushedControllers: [UIViewController] {
        ...
        /// An array of ``UIKit/UIViewController``s pushed by this FlowContainer. Order is not guaranteed.
    ...
    public extension FlowContainer {
        ...
        /// - Parameters:
        ///   - viewController: ``UIKit/UIViewController`` to be pushed
        ...
        /// - Parameters:
        ///   - viewController: ``UIKit/UIViewController`` to be presented modally
        ...
        ///   - navigationController: ``UIKit/UINavigationController`` the presented FlowContainer should attach to
    ...
    public extension FlowContainer {
        /// Pop navigation stack back to a ``UIKit/UIViewController`` based on position in the flow
        ...
        func pop(toPosition position: Int, animated: Bool = true, completion: (() -> Void)? = nil) {
        ...
        /// - Parameters:
        ///   - id: Unique identifier of the ``UIKit/UIViewController``
        ///   - animated: True if the transition should be animated. True by default
        ...
        func pop(toControllerWithId id: String, animated: Bool = true, completion: (() -> Void)? = nil) {
    ...
    extension FlowContainer {
        /// Attach the flow coordinator a ``UIKit/UINavigationController``
        ...
        /// Explicitly detach the FlowContainer from the ``UIKit/UINavigationController``
        /// **NOTE:** This does _not_ unwind the child ``UIKit/UIViewController``s presented by the FlowContainer
        /// If you want to unwind the FlowContainer before detaching look for ``FlowContainer/finish(animated:completion:)``
        public func detach() {
            guard let navigationController else { return }
