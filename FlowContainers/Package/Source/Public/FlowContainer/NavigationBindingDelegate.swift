...
extension NavigationBindingDelegate {
  public func willAttach(
    _ flowContainer: FlowContainer,
    to navigationController: UINavigationController
  ) {}
  ...
  public func didDismissAllControllers(presentedBy flowCoodinator: FlowContainer) {}
  public func shouldDetach(_ flowContainer: FlowContainer) -> Bool { true }
  public func willDetach(_ flowContainer: FlowContainer) {}
  public func didDetach(_ flowContainer: FlowContainer) {}
}
